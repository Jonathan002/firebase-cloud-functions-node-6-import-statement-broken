...
export interface _FirebaseNamespace extends FirebaseNamespace {
  INTERNAL: {
     ...
     */
    // @manual-fix: Observer<T, Error> ->  Observer<any> for executor() and onNoObservers?() arguments
    createSubscribe<T>(
      executor: (observer: Observer<any>) => void,
      onNoObservers?: (observer: Observer<any>) => void
    ): Subscribe<T>;
